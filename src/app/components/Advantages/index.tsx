                    ...
                    <div className={style.box__roadmap}>
                        <div className={`${style.roadmap__camera} ${style.roadmap__item}`}>
                            ...
                            <ul className={style.roadmap__el__list_points}>
                                <li className={style.list_points__point}><span className={style.point__main_text}>Безопасность</span> — Современные системы видеонаблюдения для защиты вашего имущества, днем и ночью, в любое время года.</li>
                        ...
                        <div className={`${style.roadmap__conditioner} ${style.roadmap__item}`}>
                            ...
                            <ul className={style.roadmap__el__list_points}>
                                <li className={style.list_points__point}><span className={style.point__main_text}>Идеальный микроклимат</span> — создадим комфортную атмосферу в любом помещении с помощью современных и энергоэффективных cплит-систем.</li>
                                <li className={style.list_points__point}><span className={style.point__main_text}>Экономия и надежность</span> — подберем сплит-систему, которая будет соответствовать вашим ожиданиям по производительности, экономичности и долговечности.</li>
