...
const Information: React.FC = () => {
    const ArrayImagesSlider = {
        ...
        projects: [
            ...
            ['/images/project_9.jpg', 'Камера видеонаблюдения для участка В Кемерово'],
            ...
            ['/images/project_27.jpg', 'Камера видеонаблюдения для безопасности участка в своем доме онлайн в Кемерово'],
            ...
            ['/images/project_34.jpg', 'Камера видеонаблюдения онлайн для слежения за домом, участком и близких'],
